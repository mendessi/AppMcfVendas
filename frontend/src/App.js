        ...
        <div className={`flex-1 transition-all duration-300 ${
          ...
          <footer className={`${darkMode ? 'bg-gray-800' : 'bg-gray-200'} text-${darkMode ? 'white' : 'gray-800'} py-3 sm:py-4 mt-auto text-xs sm:text-sm`}>
            <div className="container mx-auto px-4 text-center">
              <p>
                &copy; {new Date().getFullYear()} Solução Informática | Todos os direitos reservados
                <span style={{ marginLeft: 12, opacity: 0.7 }}>| v{APP_VERSION} - Suporte: 85-98808-5256</span>
              </p>
            </div>
          </footer>
        </div>
