...
import { FiTrash2, FiEdit, FiX, FiInbox } from 'react-icons/fi';
...
const OrcamentosCache = ({ darkMode, onClose }) => {
  ...
  const handleEditar = async (id) => {
    try {
      ...
      if (orcamento) {
        // Navegar para o formulário com os dados do orçamento
        navigate('/orcamento', { state: { orcamentoCache: orcamento } });
